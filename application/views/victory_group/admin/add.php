                    ...
                    <div class="panel-body">
                        <div class="form">
                            <form class="form-validate form-horizontal" id="feedback_form" action="" method="post">
                                ...
                                <div class="form-group ">
                                    <label for="cname" class="control-label col-lg-2">How many times did you meet for the past 3 months <span class="required">*</span></label>
                                    <div class="col-lg-10">
                                ...
                                <div class="form-group ">
                                    <label for="cname" class="control-label col-lg-2">Demographic <span class="required">*</span></label>
                                    <div class="col-lg-10">
                                ...
                                <div class="form-group ">
                                    <label for="cname" class="control-label col-lg-2">Number of Victory Group Member <span class="required">*</span></label>
                                    <div class="col-lg-10">
                                ...
                                <div class="form-group ">
                                    <label for="cname" class="control-label col-lg-2">One 2 One <span class="required">*</span></label>
                                    <div class="col-lg-10">
                                 ...
                                 <div class="form-group ">
                                    <label for="cname" class="control-label col-lg-2">Victory Weekend <span class="required">*</span></label>
                                    <div class="col-lg-10">
                                ...
                                <div class="form-group ">
                                    <label for="cname" class="control-label col-lg-2">Water Baptism <span class="required">*</span></label>
                                    <div class="col-lg-10">
                                ...
                                <div class="form-group ">
                                    <label for="cname" class="control-label col-lg-2">Making Disciples<span class="required">*</span></label>
                                    <div class="col-lg-10">
                                ...
                                <div class="form-group ">
                                    <label for="cname" class="control-label col-lg-2">Church Community <span class="required">*</span></label>
                                    <div class="col-lg-10">
                                ...
                                <div class="form-group ">
                                    <label for="cname" class="control-label col-lg-2">Foundation Class<span class="required">*</span></label>
                                    <div class="col-lg-10">
                                ...
                                <div class="form-group ">
                                    <label for="cname" class="control-label col-lg-2">Empowering Leaders<span class="required">*</span></label>
                                    <div class="col-lg-10">
                                ...
                                <div class="form-group ">
                                    <label for="cname" class="control-label col-lg-2">Leadership 113<span class="required">*</span></label>
                                    <div class="col-lg-10">
                                ...
                                <div class="form-group ">
                                    <label for="cname" class="control-label col-lg-2">Do you have an intern?<span class="required">*</span></label>
                                    <div class="col-lg-10">
