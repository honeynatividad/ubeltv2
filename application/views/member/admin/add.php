                        ...
                        <div class="form">
                            <form class="form-validate form-horizontal" id="feedback_form" action="" method="post">
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-10">
                                        <input class="form-control" id="cname" name="first_name" minlength="5" type="text" required />
                                    </div>
                                </div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-10">
                                        <input class="form-control" id="cname" name="middle_name" minlength="5" type="text" required />
                                    </div>
                                </div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-10">
                                        <input class="form-control" id="cname" name="last_name" minlength="5" type="text" required />
                                    </div>
                                </div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-10">
                                        <input class="form-control" id="cname" name="contact_number" minlength="5" type="text" required />
                                    </div>
                                </div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-10">
                                        <input class="form-control" id="cname" name="birthday" minlength="5" type="text" required />
                                    </div>
                                </div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-10">
                                        <input class="form-control" id="cname" name="email_address" minlength="5" type="text" required />
                                    </div>
                                </div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-10">
                                        <input class="form-control" id="cname" name="facebook_name" minlength="5" type="text" required />
                                    </div>
                                </div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-10">
                                        <input class="form-control" id="cname" name="name_leader" minlength="5" type="text" required />
                                    </div>
                                </div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-10">
                                        <input class="form-control datepicker" id="datepicker" data-date-format="mm/yyyy" name="one_2_one" minlength="5" type="text" required />
                                    </div>
                                </div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-10">
                                        <input class="form-control datepicker" id="datepicker" data-date-format="mm/yyyy" id="cname" name="victory_weekend" minlength="5" type="text" required />
                                    </div>
                                </div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-10">
                                        <input class="form-control datepicker" id="datepicker" data-date-format="mm/yyyy" name="water_baptism" minlength="5" type="text" required />
                                    </div>
                                </div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-10">
                                        <input class="form-control datepicker" id="datepicker" data-date-format="mm/yyyy" name="making_disciples" minlength="5" type="text" required />
                                    </div>
                                </div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-10">
                                        <input class="form-control datepicker" id="datepicker" data-date-format="mm/yyyy" name="church_community" minlength="5" type="text" required />
                                    </div>
                                </div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-10">
                                        <input class="form-control datepicker" id="datepicker" data-date-format="mm/yyyy" name="foundation_class" minlength="5" type="text" required />
                                    </div>
                                </div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-10">
                                        <input class="form-control datepicker" id="datepicker" data-date-format="mm/yyyy" name="empowering_leaders" minlength="5" type="text" required />
                                    </div>
                                </div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-10">
                                        <input class="form-control datepicker" id="datepicker" data-date-format="mm/yyyy" name="leadership_113" minlength="5" type="text" required />
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-10">
                                      ...
                                      <div class="form-group">
                                          <div class="col-lg-offset-2 col-lg-10">
                                              <input type="submit" id="submit" name="memberSubmit" class="btn btn-primary" value="ADD"/>
